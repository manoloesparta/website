...
export const projectsEntries = [
  {
    ...
    description:
      "A programming language with a silly name and an online interpreter.",
  ...
  },
  {
    ...
    description:
      "Public URL shortener as an entry for the Cloudflare Developer Summer Challenge.",
  ...
  },
  {
    ...
    description:
      "Let's celebrate Pi day. Search any number, like your phone number in the digits of Pi.",
