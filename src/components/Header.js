...
export default function Header() {
  const description = "I’m a Cloud Software Engineer with professional experience back-end development and devops. Interested in mostly in back-end development (and some front-end), cloud infrastructure, systems, programming languages, and CS in general."
